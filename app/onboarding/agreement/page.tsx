...
export default function Agreement() {
  ...
  return (
    <Card>
      <CardHeader>User Terms, Conditions, & Privacy Agreement</CardHeader>
      <CardBody style={{ overflowY: "auto", maxHeight: "200px" }}>
        ...
        <article className="prose lg:prose-xl p-12">
          ...
          <ol>
            ...
            <li>
              <h2 className="font-bold text-xl pt-4 pb-1 underline">Privacy</h2>
              <p>
          ...
          <h1 className="pt-12 pb-4 font-black text-2xl">Privacy Policy</h1>
          <ol>
            <li>
              <h2 className="font-bold text-xl pt-4 pb-1 underline">
                Introduction
