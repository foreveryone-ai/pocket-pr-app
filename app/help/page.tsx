        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
          ...
          <div className="card bg-white">
            <form
              ...
              className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 xl:pt-8 xl:pb-8"
            >
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="">
                      <textarea
                        ...
                        id="message"
                        rows={4}
                        className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 overflow-auto h-screen-25"
                        defaultValue={""}
