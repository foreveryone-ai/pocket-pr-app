                  ...
                  {step === 1 && (
                    <div style={{ overflowY: "auto", maxHeight: "200px" }}>
                      <article className="prose lg:prose-xl p-12">
                        <h1 className="pb-4 font-black text-2xl">
                          User Agreement
                        </h1>
                        <ol>
                          <li>
                            ...
                            <p>
                              ...
                              (&quot;App&quot;). By accessing or using the App,
                          ...
                          <li>
                            ...
                            <ul>
                              ...
                              <li>
                                Harass, threaten, or defame any person or
                                entity.
                              </li>
                              <li>
                                Transmit or post any content that infringes upon
                                the rights of others, including intellectual
                                property rights.
                              </li>
                              <li>
                                Engage in any activity that disrupts or
                                interferes with the proper working of the App.
                              </li>
                            </ul>
                          </li>
                          <li>
                            ...
                            <ul>
                              ...
                              <li>
                                All saved chat messages are anonymized to
                                protect user privacy. Personal identifiers are
                                removed to ensure that individual users cannot
                                be identified from the saved data.
                              </li>
                            </ul>
                          </li>
                          <li>
                            ...
                            <p>
                              ...
                              Agreement by reference, to understand how we
                          ...
                          <li>
                            ...
                            <p>
                              PocketPR reserves the right to terminate or
                              suspend your access to the App without prior
                              notice if you violate any terms of this Agreement
                          ...
                          <li>
                            ...
                            <p>
                              ...
                              PocketPR disclaims all warranties, express or
                          ...
                          <li>
                            ...
                            <p>
                              ...
                              losses, resulting from your use or inability to
                              use the App.
                            </p>
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <p>
                              ...
                              jurisdiction in which PocketPR is based, without
                          ...
                          <li>
                            ...
                            <p>
                              ...
                              <a href="mailto:help@pocketpr.app">
                                help@pocketpr.app
                              </a>
                              . By using the PocketPR App, you acknowledge that
                              you have read, understood, and agree to be bound
                              by the terms of this User Agreement.
                            </p>
                          </li>
                        </ol>
                        ...
                        <ol>
                          <li>
                            ...
                            <p>
                              ...
                              (&quot;App&quot;). Your privacy is of utmost
                              importance to us. This Privacy Policy describes
                              how PocketPR collects, uses, and protects your
                              information. By accessing or using the App, you
                              agree to this Privacy Policy in addition to the
                              User Agreement. If there&quot;s any inconsistency
                              between this Privacy Policy and the User
                          ...
                          <li>
                            ...
                            <ul>
                              <li>
                                Chat messages exchanged with the App&quot;s
                                chatbot.
                              </li>
                              <li>
                          ...
                          <li>
                            ...
                            <ul>
                              ...
                              <li>
                                Understanding user behavior and preferences to
                          ...
                          <li>
                            ...
                            <p>
                              All chat messages exchanged with the App&quot;s
                              chatbot are stored in an anonymized manner. We
                              remove all personal identifiers to ensure that
                              individual users cannot be identified from the
                              saved data.
                            </p>
                          </li>
                          <li>
                            ...
                            <p>
                              ...
                              to third parties. We may share anonymized and
                              aggregated information with third-party partners
                          ...
                          <li>
                            ...
                            <p>
                              ...
                              the information we collect and store. While no
                              system is completely secure, we strive to protect
                              your data from unauthorized access, use, or
                              disclosure.
                            </p>
                          </li>
                          <li>
                            ...
                            <p>
                              The App is not intended for use by children under
                              the age of 16. We do not knowingly collect or
                              solicit personal information from anyone under the
                              age of 16. If you are a parent or guardian and you
                          ...
                          <li>
                            ...
                            <p>
                              ...
                              Policy. We encourage you to review it
                              periodically. By continuing to use the App after
                              any changes, you are expressing your acceptance of
                              the updated policy.
                            </p>
                          </li>
                          <li>
